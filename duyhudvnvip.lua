...
local Tabs = {
	...
	Misc = Window:AddTab({ Title = "MISIC", Icon = "list-plus" }),
}
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
    while wait() do
     ...
     Tabs.Main:AddParagraph({
        Title = "LẤY ITEM",
        Content = "Tự Động lấy item"
    })


    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Tự động lấy lưỡi hái[boss]", Default = false })
	...
	spawn(function()
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Tự Động Lấy Tushita", Default = false })
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Đánh Nhà Máy[Sea2]", Default = false })
...
CamShake:Stop()
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Dịch chuyển TP", Default = false })
...
Tabs.Setting:AddParagraph({
    Title = "SETTING MASTERY",
    Content = "Chỉnh Skill Chiêu Farm Mastery"
})
...
local ToggleIsland = Tabs.Telepor:AddToggle("ToggleIsland", {Title = "Dịch Chuyển", Default = false })
